...
| 功能                    | 命令                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| :---------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 查看机器配置            | 系统版本：cat /etc/redhat-release<br />虚拟机 OR 物理机：dmesg\| grep -i virtual 或者 dmidecode -s system-product-name<br />CPU位数：uname -a<br />逻辑CPU个数：cat /proc/cpuinfo \| grep "processor" \| wc -l<br />物理CPU个数：cat /proc/cpuinfo \| grep "physical id" \| sort \| uniq \| wc -l<br />物理CPU中Core的个数：cat /proc/cpuinfo \| grep "cpu cores" \| wc -l<br />内存：free -h<br />硬盘：df -hT<br />默认语言：echo $LANG |
| 时间逆序查看            | ls -lrt                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| 查找文件                | 查找某个类在哪个jar包中：find . ".jar"\| xargs grep "CodeManager"<br />查找包含字符串的文件：grep -rn "关键字符串" /opt/<br />指定文件类型搜索特定字符串：grep -rn "port:" --include "*.yml" ./                                                                                                                                                                                                                                           |
...
| ulimit -a               | 文件打开数                                                                                                                                                                                                                                                                                                                                                                                                                                |
|查看进程的启动和运行时间|ps -eo pid,tty,user,comm,lstart,etime|
